...
coco_mdf = dataset_base.copy({
    'name': 'coco_mdf',

    # Training images and annotations
    'train_images': './data/coco_mdf_1024/train2020/',
    'train_info':   './data/coco_mdf_1024/train2020/instances_train2020.json',

    # Validation images and annotations.
    'valid_images': './data/coco_mdf_1024/test2020/',
    'valid_info':   './data/coco_mdf_1024/test2020/instances_test2020.json',

    # Whether or not to load GT. If this is False, eval.py quantitative evaluation won't work.
    'has_gt': True,

    # A list of names for each of you classes.
    'class_names': ['soft', 'black', 'scratch', 'metal', 'edge', 'oil'],
...
coco_mdf_test = dataset_base.copy({
    'name': 'coco_mdf_test',
    'valid_images': './data/coco_mdf_1024/val2020/',
    'valid_info': './data/coco_mdf_1024/val2020/instances_val2020.json',
    'has_gt': True,
...
coco_base_config = Config({
    'dataset': coco_mdf,
    'num_classes': 7, # This should include the background class
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': coco_mdf,
    'num_classes': len(coco_mdf.class_names) + 1,
